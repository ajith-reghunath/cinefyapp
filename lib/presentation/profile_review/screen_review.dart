...
import 'package:cinefy/presentation/profile_review/screen_review_widgets.dart';
...
class ScreenReview extends StatelessWidget {
  ScreenReview({super.key, this.title, this.applicantsList,required this.castingCallIndex});
        ...
        return BlocBuilder<UiBloc, UiState>(
          builder: (context, uiState) {
            return Scaffold(
                ...
                floatingActionButton: title == 'Selected'
                    ? Padding(
